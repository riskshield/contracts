...
import "./RishProductTokenBase.sol";
import "./@openzeppelin/token/ERC20/IERC20.sol" ;
import "./CompatibleERC20.sol";


contract RishProductToken is RishProductTokenBase
{
	...
	constructor(string memory categoryValue,string memory subCategoryValue,
		...
		RishProductTokenBase(categoryValue,subCategoryValue,tokenNameValue, tokenSymbolValue,paidValue,expireTimestampValue) public 
	{
	}
